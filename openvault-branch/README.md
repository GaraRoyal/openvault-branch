...
> This is a fork of [OpenVault](https://github.com/vadash/openvault) with added **chat branch awareness**. When you create a branch from an earlier message, memories from messages that don't exist in the branch are automatically pruned.
...
## 🌿 Branch Support (New in this Fork)
...
1. Detecting when you switch to a branch with fewer messages than the memories reference
2. Automatically pruning memories that reference non-existent messages
3. Cleaning up character states and relationships accordingly
4. Showing a toast notification when pruning occurs
...
## License & Credits
**OpenVault Branch** is Free & Open Source software licensed under **AGPL-3.0**
